 ...
 * the same ordering rules as class {@link edu.emory.mathcs.util.PriorityQueue} and supplies
 ...
 * @author Doug Lea
 */
public class PriorityBlockingQueue extends edu.emory.mathcs.util.AbstractQueue
    implements BlockingQueue, java.io.Serializable {
    private static final long serialVersionUID = 5595510919245408276L;

    private final edu.emory.mathcs.util.PriorityQueue q;
    ...
    public PriorityBlockingQueue() {
        q = new edu.emory.mathcs.util.PriorityQueue();
    }
    ...
    public PriorityBlockingQueue(int initialCapacity) {
        q = new edu.emory.mathcs.util.PriorityQueue(initialCapacity, null);
    }
    ...
    public PriorityBlockingQueue(int initialCapacity, Comparator comparator) {
        q = new edu.emory.mathcs.util.PriorityQueue(initialCapacity, comparator);
    }
     ...
     * edu.emory.mathcs.util.PriorityQueue}, this priority queue will be sorted according to
    ...
    public PriorityBlockingQueue(Collection c) {
        q = new edu.emory.mathcs.util.PriorityQueue(c);
    }
